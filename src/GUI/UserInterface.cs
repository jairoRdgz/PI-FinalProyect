...
namespace Proyecto_Integrador
{
    public partial class UserInterface : Form
    {
        ...
        DataTable table;
        //lista temporal para obtener todas las ocupaciones
        ...
        public void loadData()
        {
            ...
            for (int i = 1; i < lineas.Length; i++)
            {
               ...
               if(!jobs.Contains(valores[1])){
                 jobs.Add(valores[1]);

                }
                MessageBox.Show(jobs.Count, "Error Title", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void loadCharts()
        {
            ...
            ageChartInfo();
            jobChartInfo();
            foreach (String aPart in jobs)
        {
            Console.WriteLine(aPart);
                Console.WriteLine(jobs.Count+"wekete");
                MessageBox.Show(jobs.Count, "Error Title", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        }
